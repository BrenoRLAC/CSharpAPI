...
namespace API.Infrastructure.Service
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IAuthDao dao, IConfiguration configuration, ILogger<AuthService> logger, IBackgroundJobClient backgroundJobClient)
        {
            _dao = dao;
        ...
        public async Task<AuthResult> ForgotPassword(ForgotPassword request)
        {
            ...
            _backgroundJobClient.Enqueue<ISendEmail>(x => x.Send(null, new ForgotPasswordEmail
            {
                Email = access.Email,
        ...
        public async Task GenerateSecondAuth(SecondAuthenticationRequest request)
        {
            ...
            _backgroundJobClient.Enqueue<ISendEmail>(x => x.Send(null, new SecondAuthenticationEmail
            {
                Email = request.Email,
